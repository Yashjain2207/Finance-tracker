...
def plot_transactions(df):
    ...
    income_df = (df[df["category"] == "Income"]
              ...
              .reindex(df.index, fill_value=0)
                 )  #D stands for daily frequency and sum aggregates the incomes where dates are same.
    ...
    plt.plot(expense_df.index, expense_df["amount"],label="Expense",color="r")     #income.index means the date
    plt.xlabel("Date")
    plt.ylabel("Amount")
